...
<div class="container">
  <div class="row">
    <div class="col-12 py-5">
			...
			<p>
				To enquire about available animals, ask about our projects or to explore payment options and shipping options, drop us an email
				<a href="mailto:regal@regalpythons.com" class="d-block">Email us</a>
      </p>

			<p>
				Contact us on MeWe at <a href="https://mewe.com/i/markregal" class="d-block" title="contact us on me we">mewe.com/i/markregal</a>
			</p>

      <p>
				<div>
					To chat via messenger, connect with us on Facebook<br>
